...
# Plot how many singular values > 0
...
# hold the error at which the first entropy=0 occurs
# (entropy < 10^-15 for our purposes)
# it goes [q=2:[l=18,l=20,...],q=3:[l=18..]..]
first_zero = []
first_zero_q = []
...
for q in qs:
    ...
    for l in ls:
        ...
        for e in es:
            # print(q)
            filename = 'o' + str(l) + 'x20_q'+str(q)+'_e.'+str(e)+'.txt'
        ...
        first_zero_q.append(next(i for i in range(len(avg_ents_q)) if avg_ents_q[i] < 1e-15))
